...
import { llmsFullFor } from '@/lib/seo'

export const dynamic = 'force-dynamic'

/** llms-full.txt por tenant: /s/<slug>/llms-full.txt (versión extendida). */
export async function GET(_req: Request, { params }: { params: { tenant: string } }) {
  ...
  return new Response(llmsFullFor(t, data as Parameters<typeof llmsFullFor>[1]), {
