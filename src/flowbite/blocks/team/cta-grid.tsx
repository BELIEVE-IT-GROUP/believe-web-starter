...
const DEMO_MEMBERS: TeamMember[] = [
  ...
  { name: 'Helene Engels', role: 'Front-end Developer', photo: 'https://flowbite.s3.amazonaws.com/blocks/marketing-ui/team/member-4.png' },
  ...
  { name: 'Roberta Casas', role: 'VueJS Developer', photo: 'https://flowbite.s3.amazonaws.com/blocks/marketing-ui/team/member-7.png' },
  { name: 'Jese Leos', role: 'AWS Developer', photo: 'https://flowbite.s3.amazonaws.com/blocks/marketing-ui/team/member-8.png' },
  { name: 'Lana Byrd', role: 'Designer', photo: 'https://flowbite.s3.amazonaws.com/blocks/marketing-ui/team/member-9.png' },
  { name: 'Karen Nelson', role: 'Marketing & SEO', photo: 'https://flowbite.s3.amazonaws.com/blocks/marketing-ui/team/member-10.png' },
  { name: 'Neil Sims', role: 'Accountant', photo: 'https://flowbite.s3.amazonaws.com/blocks/marketing-ui/team/member-11.png' },
  { name: 'Thomas Lean', role: 'Marketing', photo: 'https://flowbite.s3.amazonaws.com/blocks/marketing-ui/team/member-12.png' },
]

export function CardsWithGridLayoutAndCTATeamSection(props: CtaGridTeamProps = {}) {
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6 lg:py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base font-normal text-gray-500 dark:text-gray-400 sm:text-xl">
            {props.subheadline ?? "You'll interact with talented professionals, will be challenged to solve difficult problems and think in new and creative ways."}
          </p>
        </div>
        ...
        <Alert color="gray" className="mx-auto mt-8 max-w-3xl lg:mt-16">
          <div className="flex flex-col justify-between gap-3 md:flex-row md:items-center md:gap-6">
            ...
            >
              {props.primaryCta?.label ?? 'Join our team'}
              <svg
                aria-hidden="true"
