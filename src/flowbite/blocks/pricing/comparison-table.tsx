      ...
      <div className="mx-auto flex max-w-screen-xl flex-col items-center px-4 py-8 lg:px-6 lg:py-16">
        ...
        <Accordion collapseAll flush className="w-full border-none">
          <Accordion.Panel>
            <Accordion.Title
              theme={{
                base: "mx-auto flex w-auto items-center justify-center px-5 py-5 font-medium text-gray-500 first:rounded-t-lg last:rounded-b-lg dark:text-gray-400",
                open: {
                  on: "text-primary-600 dark:text-primary-500",
                  off: "text-gray-500 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-500",
                },
              }}
            >
            ...
            <Accordion.Content className="max-w-full overflow-x-scroll border-none px-0">
              <div className="min-w-max overflow-hidden">
                <div className="grid grid-cols-4 gap-x-16 border-y border-gray-200 bg-gray-100 p-4 text-sm font-medium text-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-white">
