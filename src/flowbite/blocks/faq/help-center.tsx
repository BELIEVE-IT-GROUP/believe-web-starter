...
type HelpCenterProps = {
  ...
  searchNote?: string
  categories?: HelpCenterCardCategory[]
}

const DEFAULT_CATEGORIES: HelpCenterCardCategory[] = [
  {
    title: 'General',
    seeAllHref: '#',
    ...
    links: [
      ...
      { label: 'How to change privacy settings?', href: '#' },
    ],
  },
  {
    title: 'License',
    seeAllHref: '#',
    iconPath: 'M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z',
    links: [
  ...
  },
  {
    title: 'Refund policy',
    seeAllHref: '#',
    iconPath: 'M5 2a2 2 0 00-2 2v14l3.5-2 3.5 2 3.5-2 3.5 2V4a2 2 0 00-2-2H5zm4.707 3.707a1 1 0 00-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L8.414 9H10a3 3 0 013 3v1a1 1 0 102 0v-1a5 5 0 00-5-5H8.414l1.293-1.293z',
    links: [
      { label: 'How to restore your chat history', href: '#' },
...
export function HelpCenterFAQSection(props: HelpCenterProps = {}) {
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
        <div className="mx-auto mb-8 max-w-screen-md text-center lg:mb-16">
          ...
          <TextInput
            ...
            className="[&_input]:p-4 [&_input]:pl-12 [&_input]:text-base [&_input]:placeholder:text-gray-400"
          />
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {categories.map((cat, i) => (
            <div key={i} className="rounded p-4 shadow dark:bg-gray-800">
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded bg-primary-100 dark:bg-primary-900 lg:h-12 lg:w-12">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path fillRule="evenodd" d={cat.iconPath} clipRule="evenodd" />
                </svg>
              </div>
