type FeaturesDescIconItem = { title: string; description: string }

type FeaturesDescriptionIconListProps = {
  headline?: string
  description?: string
  ctaLabel?: string
  ctaHref?: string
  items?: FeaturesDescIconItem[]
}

const DEFAULT_DESC_ITEMS: FeaturesDescIconItem[] = [
...
const DESC_ICONS = [
  ...
  <><path key="1a" fillRule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clipRule="evenodd" /><path key="1b" d="M2 13.692V16a2 2 0 002 2h12a2 2 0 002-2v-2.308A24.974 24.974 0 0110 15c-2.796 0-5.487-.46-8-1.308z" /></>,
  <><path key="2a" d="M8.433 7.418c.155-.103.346-.196.567-.267v1.698a2.305 2.305 0 01-.567-.267C8.07 8.34 8 8.114 8 8c0-.114.07-.34.433-.582zM11 12.849v-1.698c.22.071.412.164.567.267.364.243.433.468.433.582 0 .114-.07.34-.433.582a2.305 2.305 0 01-.567.267z" /><path key="2b" fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-13a1 1 0 10-2 0v.092a4.535 4.535 0 00-1.676.662C6.602 6.234 6 7.009 6 8c0 .99.602 1.765 1.324 2.246.48.32 1.054.545 1.676.662v1.941c-.391-.127-.68-.317-.843-.504a1 1 0 10-1.51 1.31c.562.649 1.413 1.076 2.353 1.253V15a1 1 0 102 0v-.092a4.535 4.535 0 001.676-.662C13.398 13.766 14 12.991 14 12c0-.99-.602-1.765-1.324-2.246A4.535 4.535 0 0011 9.092V7.151c.391.127.68.317.843.504a1 1 0 101.511-1.31c-.563-.649-1.413-1.076-2.354-1.253V5z" clipRule="evenodd" /></>,
  <path key="3" d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z" />,
]

export function DescriptionWithFeatureListIconsSection(props: FeaturesDescriptionIconListProps = {}) {
  const headline = props.headline ?? 'Designed for strong teams like yours'
  const description = props.description ?? 'Here we focus on markets where creativity and innovation can unlock long-term value and growth.'
  const ctaLabel = props.ctaLabel ?? 'Learn more'
  const ctaHref = props.ctaHref ?? '#'
  const items = props.items ?? DEFAULT_DESC_ITEMS
            ...
            <div key={i}>
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900 lg:h-12 lg:w-12">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  {DESC_ICONS[i % DESC_ICONS.length]}
                </svg>
              </div>
