...
type ContactDefaultProps = {
  headline?: string
  subheadline?: string
  primaryCta?: { label?: string; href?: string }
}

export function DefaultContactForm(props: ContactDefaultProps = {}) {
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-screen-md px-4 py-8 lg:py-16">
        ...
        <p className="mb-8 text-center text-gray-500 dark:text-gray-400 sm:text-xl lg:mb-16">
          {props.subheadline ?? 'Got a technical issue? Want to send feedback about a beta feature? Need details about our Business plan? Let us know.'}
        </p>
