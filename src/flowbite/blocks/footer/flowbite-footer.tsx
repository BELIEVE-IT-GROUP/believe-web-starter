export interface FlowbiteFooterProps {
  brandName?: string;
  logoUrl?: string;
  logoAlt?: string;
  tagline?: string;
...
export function FlowbiteFooterSection({
  brandName = 'Flowbite',
  tagline = 'Flowbite is a open-source library of over 400+ web components and interactive elements built with the utility classes from Tailwind CSS.',
    ...
    <footer className="rounded-none bg-gray-50 dark:bg-gray-800">
      <div className="mx-auto max-w-screen-xl p-4 py-6 md:p-8 lg:p-10">
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-6">
          ...
          {columns.map((col) => (
            <div key={col.title} className="lg:mx-auto">
