...
export interface SocialMediaIconsFooterProps {
  brandName?: string;
...
export function SocialMediaIconsFooterSection({
  ...
  copyright = 'Flowbite',
  copyrightUrl = 'https://flowbite.com',
  newsletterPlaceholder = 'Your email',
  newsletterButtonLabel = 'Subscribe',
  onNewsletterSubmit,
}: SocialMediaIconsFooterProps = {}) {
    ...
    <footer className="rounded-none bg-white p-4 py-8 dark:bg-gray-800 md:p-8 lg:p-10">
      <div className="mx-auto max-w-screen-xl text-center">
        <div className="grid lg:grid-cols-3">
          ...
          <form className="flex w-full max-w-sm lg:ml-auto" onSubmit={handleSubmit}>
            <div className="relative w-full">
              <label
                htmlFor="social-footer-email"
