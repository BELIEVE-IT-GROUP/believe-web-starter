    ...
    <section className="bg-white antialiased dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6 lg:py-24">
        ...
        <div className="my-8 sm:my-16">
          <div className="relative mx-auto h-[600px] w-[300px] rounded-[2.5rem] border-[14px] border-gray-800 dark:border-gray-800 dark:bg-gray-800">
...
export default PhoneMockupWithAppDownloadHero
