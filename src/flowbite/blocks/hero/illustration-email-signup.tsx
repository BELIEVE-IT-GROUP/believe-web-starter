...
type IllustrationWithEmailSignupHeroProps = {
  headline?: string
  description?: string
...
export function IllustrationWithEmailSignupHero(props: IllustrationWithEmailSignupHeroProps = {}) {
  const {
    headline = "Building digital products & brands.",
    ...
    illustration = "https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/mobile-app.svg",
    illustrationAlt = "phone illustration",
  } = props
  return (
