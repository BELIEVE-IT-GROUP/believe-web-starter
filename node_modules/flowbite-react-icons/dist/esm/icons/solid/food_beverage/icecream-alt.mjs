...
const SvgIcecreamAlt = forwardRef((props, ref) => /* @__PURE__ */ jsxs(BaseIcon, { fill: "none", ref, ...props, children: [
  /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M16 12H8l4 9z" }),
  /* @__PURE__ */ jsx(
    "path",
    {
      fill: "currentColor",
...
export { SvgIcecreamAlt as default };
