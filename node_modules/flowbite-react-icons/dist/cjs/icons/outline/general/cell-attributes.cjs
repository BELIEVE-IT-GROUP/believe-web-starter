...
const SvgCellAttributes = react.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsx(baseIcon.BaseIcon, { fill: "none", ref, ...props, children: /* @__PURE__ */ jsxRuntime.jsx(
  "path",
  {
    stroke: "currentColor",
    strokeLinecap: "round",
...
module.exports = SvgCellAttributes;
//# sourceMappingURL=cell-attributes.cjs.map
