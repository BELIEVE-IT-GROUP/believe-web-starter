...
const SvgLockTime = react.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsxs(baseIcon.BaseIcon, { fill: "currentColor", ref, ...props, children: [
...
module.exports = SvgLockTime;
//# sourceMappingURL=lock-time.cjs.map
