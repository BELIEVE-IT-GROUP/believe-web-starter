...
const SvgOutgoingCall = react.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsxs(baseIcon.BaseIcon, { fill: "currentColor", ref, ...props, children: [
...
module.exports = SvgOutgoingCall;
//# sourceMappingURL=outgoing-call.cjs.map
