...
const SvgUserSettings = react.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsx(baseIcon.BaseIcon, { fill: "currentColor", ref, ...props, children: /* @__PURE__ */ jsxRuntime.jsx(
  "path",
  {
    fillRule: "evenodd",
...
module.exports = SvgUserSettings;
//# sourceMappingURL=user-settings.cjs.map
