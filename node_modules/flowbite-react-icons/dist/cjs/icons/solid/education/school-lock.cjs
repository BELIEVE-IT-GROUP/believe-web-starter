...
const SvgSchoolLock = react.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsxs(baseIcon.BaseIcon, { fill: "currentColor", ref, ...props, children: [
  ...
  /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M3.73 11.162 6 10.524V21H4a1 1 0 0 1-1-1v-7.875a1 1 0 0 1 .73-.963" })
] }));

module.exports = SvgSchoolLock;
//# sourceMappingURL=school-lock.cjs.map
