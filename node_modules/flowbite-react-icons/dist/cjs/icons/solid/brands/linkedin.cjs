...
const SvgLinkedin = react.forwardRef((props, ref) => /* @__PURE__ */ jsxRuntime.jsxs(baseIcon.BaseIcon, { fill: "currentColor", ref, ...props, children: [
  ...
  /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M7.2 8.809H4V19.5h3.2z" })
] }));

module.exports = SvgLinkedin;
